...
public class DriveCommand extends Command
{
   ...
   * @param xSpeed
   *          The speed fowards and backwards
   * @param zRotation
   *          The speed to turn the drivetrain at
   * @param squareInputs
   *          Square the inputs from the controller
   */
  ...
  public void execute( )
  {
    m_drive.driveArcade(m_xSpeed.getAsDouble( ) * 0.7, m_zRotation.getAsDouble( ) * 0.7, m_squared.getAsBoolean( ));
  }
